...
class PreviewService:
    ...
    def generate_preview(
        ...
        if not os.path.isabs(config_path):
            config_path = os.path.join(template_folder, config_path)
            ...
            while overlapping and attempts < max_attempts:
                ...
                for resolved_field in resolved_fields:
                    if self._fields_overlap(current_field, resolved_field):
                        ...
                        current_field = self._reposition_field(current_field, resolved_field, attempts)
                        break
    ...
    def _reposition_field(self, current_field: Dict, blocking_field: Dict, attempt: int) -> Dict:
